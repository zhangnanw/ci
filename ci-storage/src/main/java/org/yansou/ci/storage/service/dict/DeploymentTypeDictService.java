 ...
 */
public interface DeploymentTypeDictService extends GeneralService<DeploymentTypeDict, Long> {

	DeploymentTypeDict findByCode(Integer code) throws DaoException;
