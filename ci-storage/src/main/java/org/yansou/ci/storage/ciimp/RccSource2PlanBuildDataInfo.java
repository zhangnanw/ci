...
public final class RccSource2PlanBuildDataInfo {
    ...
    public PlanBuildData get() {
        ...
        Double projectScale = Optional.ofNullable( getMW() ).filter( Objects::nonNull ).map( Double::valueOf ).orElse( null );
        ...
        String projcetOwner = getCellValue( proObj.getString( "proprietor" ) );// 甲方、项目业主、开发商、采购人、项目法人
    ...
    private String getMW() {
        JSONObject obj = proObj;
