				...
				var dataTablesExample = $('.dataTables-example').DataTable({
					...
					"columnDefs": [
						...
						},
						{
							...
							"orderable": false,
							"render": function (data, type, full, meta) {
								return '<a href="/projectInfo/edit?id=' + data + '" class="btn btn-primary btn-xs">编辑</a>';
							},
						},
						{
							"targets": 11,
							...
							"render": function (data, type, full, meta) {
								return '<a href="javascript:;" onclick="deleteForDataTable(this)" ' +
										'res="/projectInfo/delete?ids=' + data + '" class="btn btn-primary btn-xs">删除</a>';
							},
						}
					],
					"language": {
